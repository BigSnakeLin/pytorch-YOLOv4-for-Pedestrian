...
│   └── yolo_layer.py
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200720173757403.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzgyMjYwMA==,size_16,color_FFFFFF,t_70)
# 0. Weights Download
